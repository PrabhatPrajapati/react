      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex space-x-6">
          {categories.map((cat) => (
           ...
           className={`px-4 py-2 font-poppins  text-black text-[18px] rounded-full font-[400px] transition ${
             selectedCategory === cat ? "bg-[#3D9836] border-none  text-white" : " hover:bg-gray-100"
           }`}
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative flex items-center cursor-pointer">
            ...
            <span className="text-black font-poppins font-medium mr-2">Price</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6 mb-36">
        {[1, 2, 3].map((_, index) => (
          <div key={index} className="w-[336px] bg-white  overflow-hidden">
            <img src={Card1} alt="Plastic Bottles" className="w-[336px] h-[352px] object-cover" />
            <div className="p-3 w-[336px] h-[172px] bg-[#F7F9FC] font-poppins">
              <p className="text-green-600 text-[12px] font-light">INR 1000/Tonne</p>
              <h2 className="text-[16px] font-medium text-black mt-1">Plastic credit - Cat I available</h2>
              <p className="text-gray-500 font-normal text-[14px]">Plastic Waste | Recycling</p>
              <div className="mt-3">
                <div className="flex justify-between text-gray-700 text-sm">
                  <p className="font-medium text-black text-[14px]">Product Type</p>
                  <p className="text-[14px] font-light">Category I</p>
                </div>
                <div className="flex justify-between text-gray-700 text-sm mt-1">
                  <p className="font-medium text-black text-[14px]">Credit Available</p>
                  <p className="text-[14px] font-light">1000</p>
                </div>
                <div className="flex justify-between text-gray-700 text-sm mt-1">
                  <p className="font-medium text-black text-[14px]">Minimum Purchase</p>
                  <p className="text-[14px] font-light">150</p>
                </div>
              </div>
            </div>
            <div className="p-2 ">
              <button className="text-center w-[336px] text-[14px] text-[#5F5F5F] font-medium">
                View More
              </button>
            </div>
          </div>
